...
add_action('sw_cron_update_price', 'update_price_data_sale');
...
function sw_add_cron_interval( $schedules ) {
    global $SW_QUANTITY_UPDATE_INTERVAL, $SW_PRICE_UPDATE_INTERVAL, $SW_SALE_PRICE_UPDATE_INTERVAL;
	...
	$sale_price_msg = 'Every ' . $SW_SALE_PRICE_UPDATE_INTERVAL . ' Secs';
	$schedules['update_sale_price_interval'] = array(
		'interval' => $SW_SALE_PRICE_UPDATE_INTERVAL,
		'display'  => esc_html__( $sale_price_msg ), );
